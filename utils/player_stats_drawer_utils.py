...
def draw_player_stats(output_video_frames,player_stats):
    ...
    for index, row in player_stats.iterrows():
        ...
        """
        In the context of OpenCV and image processing, the coordinate system for an image has:

        The X-axis representing the width (horizontal dimension) of the image.
        The Y-axis representing the height (vertical dimension) of the image.
        Thus:

        frame.shape[1] gives the width of the image (the number of columns or horizontal pixels).
        frame.shape[0] gives the height of the image (the number of rows or vertical pixels).
        """
